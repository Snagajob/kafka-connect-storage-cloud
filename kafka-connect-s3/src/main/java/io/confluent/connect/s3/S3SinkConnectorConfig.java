...
public class S3SinkConnectorConfig extends StorageSinkConnectorConfig {
   ...
   */
  public static final String NOTIFICATION_KAFKA_ENABLED_CONFIG =
      "notification.kafka.enabled";
  public static final String NOTIFICATION_KAFKA_TOPIC_CONFIG =
      "notification.kafka.topic";
  public static final String NOTIFICATION_KAFKA_BROKER_CONFIG =
      "notification.kafka.producer.broker";
  public static final String NOTIFICATION_KAFKA_SCHEMA_REGISTRY_CONFIG =
      "notification.kafka.schema.registry";
  public static final String NOTIFICATION_KAFKA_SASLENABLED_CONFIG =
      "notification.kafka.producer.saslEnabled";
  public static final String NOTIFICATION_KAFKA_SASLUSER_CONFIG =
      "notification.kafka.producer.saslUsername";
  public static final String NOTIFICATION_KAFKA_SASLPASSWORD_CONFIG =
      "notification.kafka.producer.saslPassword";
  ...
  protected S3SinkConnectorConfig(ConfigDef configDef, Map<String, String> props) {
    ...
    this.notificationKafkaEnabled = Boolean.valueOf(
        originalsStrings().getOrDefault("notification.kafka.enabled", "false"));
    ...
    this.notificationKafkaSaslEnabled = Boolean.valueOf(
        originalsStrings().getOrDefault("notification.kafka.sasl.enabled", "false"));
    this.notificationKafkaSaslUser =
        originalsStrings().get("notification.kafka.sasl.username");
    this.notificationKafkaSaslPassword =
        originalsStrings().get("notification.kafka.sasl.password");
  ...
  public String getNotificationKafkaBroker() {
    return notificationKafkaBroker;
  }

  public String getNotificationKafkaSchemaRegistry() {
    return notificationKafkaSchemaRegistry;
  }
